...
function displayToc(filter) {
    ...
    if (numDisplayed == postTitle.length) {
        var tocNote = '<span class="toc-note"> عدد الفلاشات: <p>' + postTitle.length + '</p> فلاشة<br/></span>';
    } else {
        var tocNote = '<span class="toc-note"> عدد الفلاشات الخاصة بقسم \'';
        tocNote += postFilter + '\' هو <p>' + numDisplayed + '</p> *** العدد الكلي للفلاشات هو <p>' + postTitle.length + '</p></span>';
    }
...
"<div id=\"toc-loading\">Loading content, please wait...<br /></div>";